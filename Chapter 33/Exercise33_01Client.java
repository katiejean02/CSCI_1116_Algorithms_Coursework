  ...
  public void start(Stage primaryStage) {
    ...
    private class ButtonListener implements EventHandler<ActionEvent>{
      ...
      public void handle(ActionEvent e){
            try{
            String input = tfAnnualInterestRate.getText();
            String input1 = tfNumOfYears.getText();
            String input2 = tfLoanAmount.getText();
            double annualInterestRate = Double.parseDouble(input); 
            int numOfYears = Integer.parseInt(input1);
            double loanAmount = Double.parseDouble(input2);
